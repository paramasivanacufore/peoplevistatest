...
import { getAbsentEmployeesToday, getDepartments, exportAbsentEmployeesToday, getShifts } from '../../../utils/attendance/apiUtils';
...
const AbsentToday = () => {
    ...
    const fetchEmployees = async () => {
        try {
            ...
            const data = await getAbsentEmployeesToday(params);
    ...
    const exportToCSV = async () => {
        try {
            ...
            const data = await exportAbsentEmployeesToday(params);
            ...
            const filename = `absent_employees_${dateStr}.csv`;
            ...
            <DataTable
                ...
                renderRow={(employee) => (
                    <tr key={employee.employee_id || employee.id} className="ui-row">
                        ...
                        <td className="ui-td">{employee.status || 'Absent'}</td>
                    </tr>
                )}
                emptyMessage="No absent employees found"
                pagination={
                    totalItems > 0 && (
